 ...
 */
final class Version20251207004917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE character ADD COLUMN webhook_link VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO character (id, owner_id, name, title, img, level, xp_current, xp_current_mj, gp, pr, end_activity, last_action_description) SELECT id, owner_id, name, title, img, level, xp_current, xp_current_mj, gp, pr, end_activity, last_action_description FROM __temp__character');
