 ...
 */
final class Version20251009144544 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO user (id, discord_id, username, role, nb_character_max, roles, password) SELECT id, discord_id, username, role, nb_character, roles, password FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, discord_id, username, role, nb_character_max, roles, password FROM user');
        $this->addSql('DROP TABLE user');
        ...
        , password VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO user (id, discord_id, username, role, nb_character, roles, password) SELECT id, discord_id, username, role, nb_character_max, roles, password FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_DISCORD_ID ON user (discord_id)');
    }
}
