 ...
 */
final class Version20251014160349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE character ADD COLUMN last_action_description VARCHAR(255) DEFAULT NULL');
    }
