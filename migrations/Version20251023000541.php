 ...
 */
final class Version20251023000541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__scenario AS SELECT id, game_master_id, name, level, date, description, img, post_link, summary_link, status FROM scenario');
        ...
        $this->addSql('INSERT INTO scenario (id, game_master_id, name, level, date, description, img, post_link, summary_link, status) SELECT id, game_master_id, name, level, date, description, img, post_link, summary_link, status FROM __temp__scenario');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scenario ADD COLUMN nb_character NUMERIC(10, 0) NOT NULL');
    }
}
